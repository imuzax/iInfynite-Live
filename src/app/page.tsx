  ...
  return (
    <>
      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden pt-16 md:pt-20">
        ...
        <div className="container-main text-center relative z-10 pt-24 md:pt-32 pb-16 md:pb-20">
          <FadeIn>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-[10px] sm:text-xs text-white/70 mb-6 md:mb-8 hover:bg-white/10 transition-colors cursor-pointer">
          ...
          <FadeIn delay={0.1}>
            <h1
              className="text-4xl sm:text-5xl md:text-7xl lg:text-[5.5rem] font-medium tracking-tight leading-[1.05] mb-4 md:mb-6 max-w-5xl mx-auto text-white px-2"
          ...
          <FadeIn delay={0.2}>
            <p className="text-base sm:text-lg md:text-xl text-white/50 max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed font-light px-4">
          ...
          <FadeIn delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
              <Link href="/contact" className="btn-primary text-sm px-8 py-3 rounded-full bg-white text-black hover:bg-white/90 w-full sm:w-auto">
                Start a Project
              </Link>
            </div>
          </FadeIn>
        ...
        <div className="container-main">
          <FadeIn>
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-2xl md:text-3xl font-medium tracking-tight text-white mb-3 md:mb-4">Empowering teams worldwide</h2>
              <p className="text-white/50 text-sm max-w-md mx-auto">Join hundreds of forward-thinking startups and enterprises scaling their operations with us.</p>
            </div>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <FadeIn key={item.title} delay={i * 0.1}>
                <div className="p-6 md:p-8 rounded-2xl bg-[#0a0a0a] border border-white/5 hover:border-white/10 transition-all duration-300 group h-full">
                  <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center mb-5 md:mb-6 group-hover:bg-white/10 transition-colors">
                  ...
                  <div className="mt-5 md:mt-6 flex items-center gap-2 text-xs text-white/40 group-hover:text-white/70 transition-colors">
        ...
        <div className="container-main">
          <FadeIn>
            <div className="text-center mb-12 md:mb-16 max-w-2xl mx-auto px-4">
              <div className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest mb-3 md:mb-4">Features</div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium tracking-tight text-white">Small teams waste hours<br className="hidden sm:block" />switching between tools</h2>
            </div>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <FadeIn key={item.title} delay={i * 0.1}>
                <div className="p-6 md:p-8 rounded-2xl bg-[#0a0a0a] border border-white/5 hover:border-white/20 transition-all duration-300 group relative overflow-hidden h-full">
                  {/* Subtle hover glow */}
                  ...
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-[#111] border border-white/10 flex items-center justify-center mb-5 md:mb-6 relative z-10">
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
            <FadeIn>
              <div className="rounded-3xl bg-[#0a0a0a] border border-white/5 p-6 md:p-8 lg:p-12 h-full flex flex-col relative overflow-hidden group min-h-[400px]">
                <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-white/5 to-transparent pointer-events-none" />
                <div className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest mb-3 md:mb-4 relative z-10">Integration</div>
                <h3 className="text-xl sm:text-2xl md:text-3xl font-medium text-white mb-3 md:mb-4 relative z-10">Works With the Tools<br />You Already Use</h3>
                <p className="text-white/50 text-sm mb-8 md:mb-12 max-w-sm relative z-10">Seamlessly connect your existing tech stack with our custom APIs and integrations.</p>
                
                <div className="mt-auto flex justify-center relative z-10 pb-4">
                  <div className="w-40 h-40 md:w-48 md:h-48 rounded-full border border-white/10 flex items-center justify-center bg-[#111] shadow-[0_0_50px_rgba(255,255,255,0.05)]">
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border border-white/20 flex items-center justify-center">
            ...
            <FadeIn delay={0.1}>
              <div className="rounded-3xl bg-[#0a0a0a] border border-white/5 p-6 md:p-8 lg:p-12 h-full flex flex-col relative overflow-hidden group min-h-[400px]">
                ...
                <div className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest mb-3 md:mb-4 relative z-10">Scale</div>
                <h3 className="text-xl sm:text-2xl md:text-3xl font-medium text-white mb-3 md:mb-4 relative z-10">Loved by Teams That<br />Scale Fast</h3>
                <p className="text-white/50 text-sm mb-8 md:mb-12 max-w-sm relative z-10">We build architectures that handle millions of requests without breaking a sweat.</p>
                
                <div className="mt-auto flex justify-end relative z-10">
                  <div className="w-full max-w-[200px] md:max-w-xs h-32 md:h-40 rounded-2xl bg-[#151515] border border-white/10 shadow-2xl flex items-center justify-center">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-white/20 flex items-center justify-center">
                      <Play size={14} className="text-white/70 ml-1" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 md:py-24 relative border-t border-white/5">
        <div className="container-main">
          <FadeIn>
            <div className="text-center mb-12 md:mb-16 max-w-2xl mx-auto px-4">
              <div className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest mb-3 md:mb-4">Our Process</div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium tracking-tight text-white">How we turn ideas into reality</h2>
            </div>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <FadeIn key={step.num} delay={i * 0.1}>
                <div className="p-6 md:p-8 rounded-2xl bg-[#0a0a0a] border border-white/5 h-full relative group">
                  <div className="text-3xl md:text-4xl font-bold text-white/5 mb-4 md:mb-6 group-hover:text-white/10 transition-colors" style={{ fontFamily: "var(--font-heading)" }}>
                    {step.num}
                  </div>
                  <h3 className="text-base md:text-lg font-medium text-white mb-2 md:mb-3">{step.title}</h3>
      ...
      {/* ====== CONTACT & CONNECT ====== */}
      <section className="py-20 md:py-32 relative border-t border-white/5 overflow-hidden" id="contact">
        ...
        <div className="container-main relative z-10">
          <FadeIn>
            <div className="text-center mb-12 md:mb-16 px-4">
              <div className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest mb-3 md:mb-4">Let's Connect</div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium tracking-tight text-white mb-4">Ready to Start Your Project?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
            {/* Contact Info */}
            <FadeIn delay={0.1}>
              <div className="p-6 md:p-10 rounded-3xl bg-[#0a0a0a] border border-white/5 flex flex-col h-full relative overflow-hidden group">
                <div className="absolute top-0 left-0 w-64 h-64 bg-white/5 rounded-full blur-[80px] pointer-events-none" />
                <h3 className="text-lg md:text-xl font-medium text-white mb-6 md:mb-8 relative z-10">Contact Information</h3>
            ...
            <FadeIn delay={0.2}>
              <div className="p-6 md:p-10 rounded-3xl bg-[#0f0f0f] border border-white/10 flex flex-col h-full relative overflow-hidden">
                <div className="absolute bottom-0 right-0 w-64 h-64 bg-white/5 rounded-full blur-[80px] pointer-events-none" />
                <h3 className="text-lg md:text-xl font-medium text-white mb-6 md:mb-8 relative z-10">Send us a message</h3>
                
                <form className="space-y-4 relative z-10 flex-1 flex flex-col">
                  <input type="text" placeholder="Name" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-white/30 focus:outline-none focus:border-white/30 transition-colors" />
      ...
      <section className="py-20 md:py-32 relative">
        <div className="container-main">
          <FadeIn>
            <div className="text-center mb-12 md:mb-16 px-4">
              <div className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest mb-3 md:mb-4">Reviews</div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium tracking-tight text-white mb-4">Loved by Teams That Scale Fast</h2>
            </div>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { text: "A truly premium experience from start to finish. Our conversions doubled after the redesign.", author: "Michael T.", role: "Marketing Director" }
            ].map((review, i) => (
              <FadeIn key={i} delay={i * 0.1}>
                <div className="p-6 md:p-8 rounded-2xl bg-[#0a0a0a] border border-white/5 h-full flex flex-col group hover:border-white/10 transition-colors">
                  <div className="flex gap-1 text-accent mb-4 md:mb-6">
                    {[1,2,3,4,5].map(star => <Star key={star} size={14} fill="currentColor" />)}
                  </div>
                  <p className="text-white/70 text-sm leading-relaxed mb-6 md:mb-8 flex-1">"{review.text}"</p>
                  <div className="mt-auto">
                    <div className="font-medium text-white text-sm mb-1">{review.author}</div>
