    ...
    <footer className="relative z-10 border-t border-white/10 bg-[#050507] text-white overflow-hidden">
      ...
      <div className="container-main py-16 md:py-20 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col justify-between space-y-6 lg:pr-8">
            ...
            <div className="space-y-2.5 pt-2 text-sm text-white/70">
          ...
          {footerLinks.map((column) => (
            <div key={column.title} className="lg:col-span-1 flex flex-col">
              <h4
                className="text-sm font-semibold text-white tracking-wide mb-4"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                {column.title}
              </h4>
